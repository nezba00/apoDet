...
#SBATCH --output=./slurm_out/ds2_%j.out         # Standard output file (%j expands to jobID)
#SBATCH --error=./slurm_out/ds2_%j.err          # Standard error file (%j expands to jobID)
